...
define('client/helpers/str-concat', ['exports', 'ember'], function (exports, _ember) {
...
define('client/models/seat', ['exports', 'ember-data'], function (exports, _emberData) {
	exports['default'] = _emberData['default'].Model.extend({
		...
		myReservationCount: _emberData['default'].attr('number'),
		reservationCount: _emberData['default'].attr('number'),
		code: _emberData['default'].attr('string')
	});
});
				...
				if (_error) {
					...
					_ember['default'].$.ajax({
						...
						data: {
							...
							otherInformation: _error.message
						}
					});
					_ember['default'].Logger.error("error:" + _error.message + "-> " + _error.stack);
...
define('client/pods/components/help-box/component', ['exports', 'ember'], function (exports, _ember) {
	exports['default'] = _ember['default'].Component.extend({
		tagName: '',
		helpTextCode: null,
		showYield: false
...
define("client/pods/components/help-box/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "2kdmV4sL", "block": "{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"card hide-on-small-only\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"card-image\"],[\"static-attr\",\"style\",\"background-image:url('/assets/images/q1.jpg');height:180px\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"card-title white-text\"],[\"flush-element\"],[\"append\",[\"helper\",[\"t\"],[\"help.title\"],null],false],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"card-content\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"append\",[\"helper\",[\"t\"],[[\"get\",[\"helpTextCode\"]]],null],false],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"if\"],[[\"get\",[\"showYield\"]]],null,0],[\"close-element\"]],\"locals\":[],\"named\":[],\"yields\":[\"default\"],\"blocks\":[{\"statements\":[[\"text\",\"\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"card-action\"],[\"static-attr\",\"style\",\"padding-top:0\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"yield\",\"default\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "client/pods/components/help-box/template.hbs" } });
});
...
define('client/pods/components/placc-calendar/component', ['exports', 'ember'], function (exports, _ember) {
    ...
    exports['default'] = _ember['default'].Component.extend({
        ...
        prevInactive: _ember['default'].computed('startDay', function () {
            return moment().startOf('isoWeek').isSame(this.get('startDay'));
        }),
        nextInactive: _ember['default'].computed('startDay', function () {
...
define("client/pods/components/placc-calendar/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "KN4/oOZY", "block": "{\"statements\":[[\"text\",\" \"],[\"comment\",\" Modal Structure \"],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"id\",\"calendarModal\"],[\"static-attr\",\"class\",\"modal\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"modal-content\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"h4\",[]],[\"flush-element\"],[\"text\",\"Reservation calendar\"],[\"close-element\"],[\"text\",\"\\n\"],[\"open-element\",\"div\",[]],[\"dynamic-attr\",\"class\",[\"concat\",[[\"unknown\",[\"componentCssClassName\"]],\"_calendar\"]]],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"items\"]]],null,10],[\"block\",[\"unless\"],[[\"get\",[\"prevInactive\"]]],null,3,2],[\"block\",[\"unless\"],[[\"get\",[\"nextInactive\"]]],null,1,0],[\"close-element\"],[\"text\",\"\\n\\n  \"],[\"close-element\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"modal-footer\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"#!\"],[\"static-attr\",\"class\",\" modal-action modal-close waves-effect waves-green btn-flat\"],[\"modifier\",[\"action\"],[[\"get\",[null]],\"close\"]],[\"flush-element\"],[\"text\",\"OK\"],[\"close-element\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"\\t\"],[\"open-element\",\"div\",[]],[\"dynamic-attr\",\"class\",[\"concat\",[[\"unknown\",[\"componentCssClassName\"]],\"_next inactive\"]]],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"material-icons\"],[\"flush-element\"],[\"text\",\" \"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\t\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t\"],[\"open-element\",\"div\",[]],[\"dynamic-attr\",\"class\",[\"concat\",[[\"unknown\",[\"componentCssClassName\"]],\"_next\"]]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"nextWeek\"]],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"material-icons\"],[\"flush-element\"],[\"text\",\"keyboard_arrow_right\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t\"],[\"open-element\",\"div\",[]],[\"dynamic-attr\",\"class\",[\"concat\",[[\"unknown\",[\"componentCssClassName\"]],\"_prev inactive\"]]],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"material-icons\"],[\"flush-element\"],[\"text\",\" \"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t\"],[\"open-element\",\"div\",[]],[\"dynamic-attr\",\"class\",[\"concat\",[[\"unknown\",[\"componentCssClassName\"]],\"_prev\"]]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"prevWeek\"]],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"i\",[]],[\"static-attr\",\"class\",\"material-icons\"],[\"flush-element\"],[\"text\",\"keyboard_arrow_left\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t\"],[\"open-element\",\"a\",[]],[\"dynamic-attr\",\"class\",[\"concat\",[[\"unknown\",[\"componentCssClassName\"]],\"_status_reserved2\"]]],[\"flush-element\"],[\"text\",\"RESERVED\"],[\"close-element\"],[\"text\",\"\\t\\n\\t\"]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t\"],[\"open-element\",\"a\",[]],[\"dynamic-attr\",\"class\",[\"concat\",[[\"unknown\",[\"componentCssClassName\"]],\"_status_reserved2_my\"]]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"release\",[\"get\",[\"element\",\"reservation\",\"id\"]]]],[\"flush-element\"],[\"text\",\"RELEASE\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t\"],[\"comment\",\"a class=\\\"{{!componentCssClassName}}_status_reserved1\\\" {{!action 'release' element.reservation.id}}>PREPARED</a\"],[\"text\",\"\\n\"],[\"block\",[\"if\"],[[\"get\",[\"element\",\"future\"]]],null,5]],\"locals\":[]},{\"statements\":[[\"block\",[\"if\"],[[\"get\",[\"element\",\"owner\"]]],null,6,4]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t\"],[\"open-element\",\"a\",[]],[\"dynamic-attr\",\"class\",[\"concat\",[[\"unknown\",[\"componentCssClassName\"]],\"_status_free\"]]],[\"modifier\",[\"action\"],[[\"get\",[null]],\"reserv\",[\"get\",[\"element\",\"date\"]]]],[\"flush-element\"],[\"text\",\"reservation\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"block\",[\"unless\"],[[\"get\",[\"element\",\"inactive\"]]],null,8]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t\"],[\"open-element\",\"div\",[]],[\"dynamic-attr\",\"class\",[\"concat\",[[\"unknown\",[\"componentCssClassName\"]],\"_day_\",[\"helper\",[\"date-format\"],[[\"get\",[\"element\",\"date\"]],\"e\"],null],\" \",[\"helper\",[\"if\"],[[\"get\",[\"element\",\"today\"]],\"today\"],null],\" \",[\"helper\",[\"if\"],[[\"get\",[\"element\",\"inactive\"]],\"placc-date-inactive\"],null]]]],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"dynamic-attr\",\"class\",[\"concat\",[[\"unknown\",[\"componentCssClassName\"]],\"_month placc-month\"]]],[\"flush-element\"],[\"append\",[\"helper\",[\"date-format\"],[[\"get\",[\"element\",\"date\"]],\"MMMM\"],null],false],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"dynamic-attr\",\"class\",[\"concat\",[[\"unknown\",[\"componentCssClassName\"]],\"_date placc-date\"]]],[\"flush-element\"],[\"append\",[\"helper\",[\"date-format\"],[[\"get\",[\"element\",\"date\"]],\"D\"],null],false],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"dynamic-attr\",\"class\",[\"concat\",[[\"unknown\",[\"componentCssClassName\"]],\"_week placc-week\"]]],[\"flush-element\"],[\"append\",[\"helper\",[\"date-format\"],[[\"get\",[\"element\",\"date\"]],\"ddd\"],null],false],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"if\"],[[\"helper\",[\"eq-o\"],[[\"get\",[\"element\",\"reservation\"]],0],null]],null,9,7],[\"text\",\"\\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"element\"]}],\"hasPartials\":false}", "meta": { "moduleName": "client/pods/components/placc-calendar/template.hbs" } });
});
...
define('client/pods/error-page/route', ['exports', 'ember'], function (exports, _ember) {
  exports['default'] = _ember['default'].Route.extend({});
});
define("client/pods/error-page/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "QGpfALls", "block": "{\"statements\":[[\"block\",[\"page-view\"],null,[[\"scrollToTop\"],[true]],3],[\"text\",\"\\n\"]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"append\",[\"helper\",[\"t\"],[\"button.open\"],null],false]],\"locals\":[]},{\"statements\":[[\"text\",\"\\t\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"ember-view card question-card\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"card-image\"],[\"dynamic-attr\",\"style\",[\"concat\",[\"background-image:url('\",[\"helper\",[\"if\"],[[\"get\",[\"level\",\"img\"]],[\"get\",[\"level\",\"img\"]],\"/assets/images/building/level.JPG\"],null],\"');\"]]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"span\",[]],[\"static-attr\",\"class\",\"card-title question-title\"],[\"static-attr\",\"style\",\"display: block;padding:16px 24px\"],[\"flush-element\"],[\"append\",[\"unknown\",[\"level\",\"name\"]],false],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"card-action\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"block\",[\"link-to\"],[\"level\",[\"get\",[\"level\",\"id\"]]],null,0],[\"text\",\"\\n\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[\"level\"]},{\"statements\":[[\"text\",\"Start here >>\"]],\"locals\":[]},{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"section no-pad-bot\"],[\"static-attr\",\"id\",\"index-banner\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"container\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col s12\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"blockquote\",[]],[\"static-attr\",\"style\",\"background-color:white\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\tSomething is wrong with requested data! \\n\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\tPlease try to navigate with application buttons! \"],[\"block\",[\"link-to\"],[\"index\"],null,2],[\"text\",\" \\n\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\t\\t\\t\\n\\t\\t\\t\"],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n    \\t\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"model\",\"level\"]]],null,1],[\"text\",\"\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "client/pods/error-page/template.hbs" } });
});
...
define("client/pods/index/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "K/+KC1eu", "block": "{\"statements\":[[\"block\",[\"page-view\"],null,[[\"scrollToTop\"],[true]],1]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"\\t\\t\\t\\t\\t\"],[\"open-element\",\"a\",[]],[\"static-attr\",\"href\",\"#\"],[\"static-attr\",\"class\",\"waves-effect waves-light btn accent-btn white-text\"],[\"flush-element\"],[\"append\",[\"helper\",[\"t\"],[\"button.how_to_use\"],null],false],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"section no-pad-bot\"],[\"static-attr\",\"id\",\"index-banner\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"container\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"row\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col s12 m7\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"append\",[\"helper\",[\"company-list\"],null,[[\"companyList\",\"infinityLoad\"],[[\"get\",[\"model\"]],\"infinityLoad\"]]],false],[\"text\",\"\\n\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"col s12 m5\"],[\"flush-element\"],[\"text\",\"\\n\\t\\t\\t\\t\"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"toc-wrapper\"],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"help-box\"],null,[[\"helpTextCode\",\"showYield\"],[\"help.index\",true]],0],[\"text\",\"\\t\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\t\\t\\t\\t\\t\\n\\t\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\\t\"],[\"close-element\"],[\"text\",\"\\n\\t\"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "client/pods/index/template.hbs" } });
});
...
define('client/pods/level/route', ['exports', 'ember', 'client/utils/auth-route'], function (exports, _ember, _clientUtilsAuthRoute) {
	exports['default'] = _clientUtilsAuthRoute['default'].extend({
...
define('client/pods/profile/controller', ['exports', 'ember', 'client/app'], function (exports, _ember, _clientApp) {
    exports['default'] = _ember['default'].Controller.extend({
        ...
        showLeftSide: _ember['default'].computed('applicationController.currentPath', 'isLoggedIn', function () {
...
define('client/pods/profile/index/controller', ['exports', 'ember'], function (exports, _ember) {
	exports['default'] = _ember['default'].Controller.extend({
		...
		isLoggedIn: _ember['default'].computed.readOnly('session.isLoggedIn'),
		username: _ember['default'].computed.readOnly('session.username'),
		levels: _ember['default'].computed('model', function () {
			var l = [];
			this.get('model').reservations.map(function (item) {
				if (!l.find(function (i) {
					return i.name === item.seat.level.name;
				})) {
...
define("client/pods/profile/index/template", ["exports"], function (exports) {
  exports["default"] = Ember.HTMLBars.template({ "id": "ElAOW+GZ", "block": "{\"statements\":[[\"block\",[\"if\"],[[\"get\",[\"isLoggedIn\"]]],null,5]],\"locals\":[],\"named\":[],\"yields\":[],\"blocks\":[{\"statements\":[[\"text\",\"\\n  \"],[\"append\",[\"helper\",[\"t\"],[\"signup.take_seat\"],null],false],[\"text\",\" >>\"]],\"locals\":[]},{\"statements\":[[\"text\",\"  \"],[\"append\",[\"helper\",[\"t\"],[\"profile.noreservation\"],null],false],[\"text\",\"\\n  \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"company\",1],[[\"class\"],[\"take-seat-link\"]],0],[\"close-element\"],[\"text\",\" \\n\"]],\"locals\":[]},{\"statements\":[[\"text\",\"\\n    \"],[\"append\",[\"unknown\",[\"level\",\"name\"]],false],[\"text\",\" >>\"]],\"locals\":[]},{\"statements\":[[\"text\",\"    \"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"block\",[\"link-to\"],[\"level\",[\"get\",[\"level\",\"id\"]]],[[\"class\"],[\"take-seat-link\"]],2],[\"close-element\"],[\"text\",\" \\n\\n\"]],\"locals\":[\"level\"]},{\"statements\":[[\"text\",\"\\t\"],[\"append\",[\"helper\",[\"t\"],[\"profile.reservation.text\"],[[\"count\"],[[\"get\",[\"model\",\"reservations\",\"length\"]]]]],false],[\"open-element\",\"br\",[]],[\"flush-element\"],[\"close-element\"],[\"text\",\"\\n\"],[\"block\",[\"each\"],[[\"get\",[\"levels\"]]],null,3],[\"text\",\"\\n\"]],\"locals\":[]},{\"statements\":[[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"card horizontal\"],[\"flush-element\"],[\"text\",\"\\n  \"],[\"comment\",\"div class=\\\"card-image\\\">\\n    <img src=\\\"/assets/images/card_bg.jpg\\\">\\n  </div\"],[\"text\",\"\\n  \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"card-stacked\"],[\"flush-element\"],[\"text\",\"\\n    \"],[\"open-element\",\"div\",[]],[\"static-attr\",\"class\",\"card-content\"],[\"flush-element\"],[\"text\",\"\\n\\t\"],[\"open-element\",\"p\",[]],[\"flush-element\"],[\"text\",\"\\n\"],[\"block\",[\"if\"],[[\"helper\",[\"gt-num\"],[[\"get\",[\"model\",\"reservations\",\"length\"]],0],null]],null,4,1],[\"text\",\"\\t\"],[\"close-element\"],[\"text\",\"\\n    \"],[\"close-element\"],[\"text\",\"\\n    \"],[\"comment\",\"div class=\\\"card-action\\\">\\n      <a href=\\\"#\\\">This is a link</a>\\n    </div\"],[\"text\",\"\\n  \"],[\"close-element\"],[\"text\",\"\\n\"],[\"close-element\"],[\"text\",\"\\n\"]],\"locals\":[]}],\"hasPartials\":false}", "meta": { "moduleName": "client/pods/profile/index/template.hbs" } });
});
...
define('client/utils/auth-route', ['exports', 'ember'], function (exports, _ember) {
	exports['default'] = _ember['default'].Route.extend({
		session: _ember['default'].inject.service(),
		isLoggedIn: _ember['default'].computed.readOnly('session.isLoggedIn'),
